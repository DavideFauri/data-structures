...
data ExampleTree a = (Show a, Eq a) => ExampleTree { name :: String
                                                   , tree :: Tree a
                                                   , toStr :: String
                                                   , toList :: [a]
                                                   }
...
tests ex = testGroup (name ex) [ testCase "is pretty printed" $ testShow ex
...
testTree :: TestTree
testTree = testGroup "Tree" [ tests emptyTree
                            , tests smallIntTree
                            ]

emptyTree :: ExampleTree Int
emptyTree = ExampleTree { name = "Empty tree"
                        , tree = Leaf
                        , toStr = ""
                        , toList = []
                        }
...
smallIntTree = ExampleTree { name = "Small tree of Int"
